...
La fonction effectue le traitement suivant : - Si la chaine excède 15 caractères, alors on affiche la chaîne coupée jusqu'à 15 caractères puis '...' - Sinon elle renvoie simplement la chaîne de caractères
